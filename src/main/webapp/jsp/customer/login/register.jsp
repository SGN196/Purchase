...
<body >
    ...
    <div  style="text-align:center">
        <h1>注册</h1>
        <form class="form-inline" action="${ctx}/dev/devRegister" onsubmit="return checkForm();" method="post">
            <div class="form-group ">
                <label  >用户名</label>
                <input class="form-control" type="text" id="devCode" name="devCode" onblur="DevCodeQuery()"  placeholder="请输入用户名" >
            ...
            <div class="form-group">
                <label >密&nbsp;码</label>
                <input class="form-control" id="devPassword1" type="password" name="devPassword" placeholder="请输入密码" autocomplete="off" >
            ...
            <div class="form-group">
                <label >确认密码</label>
                <input  class="form-control" id="devPassword2" type="password" onblur="CheckPassword()"  placeholder="请再次输入密码" autocomplete="off" >
            ...
            <div class="form-group">
                <label >昵称</label>
                <input  class="form-control" type="text" id="devName" name="devName"  placeholder="请输入昵称" autocomplete="off" >
    ...
    <script type="text/javascript">
        ...
        <%--$(function(){--%>
            <%--$('#devCode').bind('input propertychange', function(){--%>
                <%--var devCode = $('#devCode').val();--%>
                ...
                <%--$.ajax({--%>
                    ...
                    <%--success:function(data){--%>
                        <%--if(data == 1){--%>
                            <%--$('#prompt').html('<p color="red">当前用户名已经存在</p>');--%>
                        <%--}else{--%>
                            <%--$('#prompt').html('<p color="green">当前用户名可以使用</p>');--%>
                        <%--}--%>
